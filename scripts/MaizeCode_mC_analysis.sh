...
##### 
##### It creates bigwig files for each biological rep for each sequence context (CG. CHG and CHH)
#####
##### Requirements: bedGraphToBigWig
"
...
pidsa=()
while read data line tissue met paired ref_dir
do
